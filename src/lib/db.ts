...
// Lazy proxy: defers createPrismaClient() (and the DATABASE_URL check) until the
// first actual DB access at runtime. This prevents `next build` page-data
// collection from requiring DATABASE_URL, which is not available at build time.
